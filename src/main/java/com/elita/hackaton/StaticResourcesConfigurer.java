...
public class StaticResourcesConfigurer extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(final ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/images/**").addResourceLocations("classpath:/static/images/").setCachePeriod(24 * HOUR);
		registry.addResourceHandler("/fonts/**").addResourceLocations("classpath:/static/fonts/").setCachePeriod(24 * HOUR);
	}
